...
- [ ] **Phase 1: 完整实现 GRACE 与实验代码** — 主方法、核心对照、GPU后端和实验脚本全部写完，完成本机可跑的测试。
...
**Plans:** TBD — 按代码模块拆成短执行清单；不另做一轮文档审批。
...
- 首批4×A100，后续两组各8×RTX5090；机器配置在部署时处理。
...
|-------|----------------|--------|-----------|
| 1. 完整实现 GRACE 与实验代码 | 0/TBD | Not started | - |
| 2. 运行最小证伪实验 | 0/TBD | Not started | - |

21项需求已映射；代码尚未开始，真实实验尚未运行。
